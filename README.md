[readme.md](https://github.com/user-attachments/files/28506867/readme.md)
# python-work
...
所有图片保存在 `data/可视化/` 并自动打包为 `c101_eda_visualization.zip`。

求解器生成的路线图示例：  
（此处可插入 `results/ga_routes.png` 的截图链接）
